...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $coin['coinTrxAmount']     = CoinHistory::where('user_id', $id)->sum('amount');
        $coin['totalCoinQuantity'] = CoinHistory::where('user_id', $id)->sum('coin_quantity');

        $totalReferral = User::where('ref_by', $id)->count();
        $totalAuction  = Auction::where('auction_owner', $id)->count();
        ...
        return view('admin.users.detail', compact('pageTitle', 'coin','totalReferral','totalAuction','user','totalDeposit','totalWithdrawals','totalTransaction','countries'));
    }
