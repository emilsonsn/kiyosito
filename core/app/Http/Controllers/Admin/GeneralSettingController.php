...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'coin_text'       => 'required|string|max:40',
            'coin_sym'        => 'required|string|max:40',
        ...
        $general->coin_text       = $request->coin_text;
        $general->coin_sym        = $request->coin_sym;
    ...
    {
        $general = gs();
        $general->referral_commission = $request->referral_commission ? Status::ENABLE : Status::DISABLE;
        ...
        $general->wp                  = $request->wp ?  Status::ENABLE : Status::DISABLE;
        $general->auction_permission  = $request->auction_permission ? Status::ENABLE : Status::DISABLE;
