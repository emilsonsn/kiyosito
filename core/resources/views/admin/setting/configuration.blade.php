            ...
            <form method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Auction Permission')</p>
                                <p class="mb-0">
                                    <small>@lang('If you disable this module, no one will be able to create an auction offer on their coin, or buy and sell coins!')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="auction_permission" @if(gs('auction_permission')) checked @endif>
                            </div>
                        </li>

                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Withdraw Permission')</p>
                                <p class="mb-0">
                                    <small>@lang('If you disable this module, no one can withdraw their money')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="wp" @if(gs('wp')) checked @endif>
                            </div>
                        </li>

                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Referral')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, any user can invite people to use the system, The referrers will get commission as per')<a href="{{ route('admin.referral.index') }}">@lang(' commission setting')</a></small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="referral_commission" @if(gs('referral_commission')) checked @endif>
                            </div>
                        </li>
