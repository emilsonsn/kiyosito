        ...
        <div class="col-12">
            ...
            <div class="row gy-4 mt-3">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.report.coins',$user->id) }}"
                        title="Total Coin Trx. Amount"
                        icon="las la-funnel-dollar"
                        value="{{ showAmount($coin['coinTrxAmount']) }}"
                        bg="2"
                        type="3"
                    />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.report.coins',$user->id) }}"
                        title="Total Purchase Coins"
                        icon="las la-coins"
                        value="{{$coin['totalCoinQuantity'] }} {{ __(gs('coin_text')) }}"
                        bg="dark"
                    />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.report.referral.user',$user->id) }}"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.report.auctions',$user->id) }}"
                        title="Total Offering Auctions"
                        icon="lab la-sellsy"
                        value="{{ $totalAuction }}"
                        bg="13"
                        type="3"
