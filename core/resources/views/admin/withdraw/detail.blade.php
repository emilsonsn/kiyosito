            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    @if ($withdrawal->status == Status::PAYMENT_PENDING)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn-outline--success btn-sm ms-1" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.withdraw.data.approve') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>@lang('Have you sent') <span
                                class="fw-bold text--success">{{ showAmount($withdrawal->final_amount, currencyFormat: false) }}
